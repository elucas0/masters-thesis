...
That residual is a compression gap rather than a domain gap: Section~\ref{sec:rq2-results} shows the student performs almost identically on the two sensors, so what separates it from the teacher is capacity and initialisation.
...
Flood segmentation may understate the severity of the domain-gap problem, which is part of why the LULC task was adopted as the primary benchmark.
