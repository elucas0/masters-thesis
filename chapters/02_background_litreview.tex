...
This makes ViT-based models strong candidates for on-board EO applications\cite{le2024onboard}, but their computational and memory requirements are often prohibitive for deployment on resource-constrained satellites\cite{chou2023edge}.
