...
Most applications of distillation to on-board EO models compress within a single architecture family, distilling into a smaller model of the same type\cite{le2025semantic}.
