...
Image-processing networks, convolutional and deep neural networks in particular, are poorly matched to the processors typically flown, which are chosen for reliability and power efficiency rather than throughput and offer limited computation and memory\cite{barretta2026onboardaireview}.
...
\ \cite{du2025onorbitdemonstrationgeospatialfoundation}, who deployed a compressed Prithvi-family GeoFM on Kanyini and the IMAGIN-e payload, adapting via real-label head retraining rather than encoder-level DA.
