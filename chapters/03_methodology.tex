...
\begin{figure}[htp]
    ...
    \caption{Mean cross-sensor approximation error (Equation~\eqref{eq:approx-error}) by dominant ESA WorldCover class, over 5,000 patches.
        ...
        Three classes show 0\% presence in the sample (moss and lichen, snow and ice, mangroves) because they are rare in the dataset; they are reported for completeness.
    }
...
\begin{figure}[htp]
    ...
    \caption{A coastal wetland patch (mean approximation error $1.24$, above the dataset-wide mean of $0.91$).
...
\begin{figure}[htp]
    ...
    \caption{A tree-cover/grassland boundary patch (mean approximation error $0.96$).}
...
\begin{figure}[htp]
    ...
    \caption{A cropland patch in which the real $\Phi$-sat-2 view shows severe band-to-band misalignment, which is not present in the Sentinel-2 view.
        This real flight data shows the same phenomenon Equation~\eqref{eq:misalign-l1a} models synthetically.
        This is direct evidence that band misalignment can sometimes be a severe real-sensor artifact.
