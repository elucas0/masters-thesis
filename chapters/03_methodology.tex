...
\begin{figure}[htp]
    \centering
    \includegraphics[width=0.75\textwidth]{fig_clouds.png}
    \caption{Cumulative distribution of per-patch cloud cover, separating thick and thin cloud; 73\% of patches fall below 5\% total cloud cover.}
    \label{fig:clouds}
\end{figure}
