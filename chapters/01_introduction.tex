...
Separately, $\Phi$satNet, a U-Net-based GeoFM developed within the same research group specifically for on-board execution on $\Phi$-sat-2 hardware, sidesteps the ViT-compatibility problem by training a compact, non-transformer architecture from scratch on a purpose-built pre-training corpus, instead of adapting an existing large-scale pre-trained model.
