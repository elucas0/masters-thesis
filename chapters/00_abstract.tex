...
The distilled, domain-adapted student outperforms a supervised baseline of identical architecture trained directly on the target sensor at a representative labeled-data budget (\acref{mIoU} $0.4532$ vs.\ $0.3989$), but it loses to that same baseline at a smaller one (\acref{mIoU} $0.2679$ vs.\ $0.2916$).
